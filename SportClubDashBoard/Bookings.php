                        ...
                        ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap event_name">
                                            <div class="text-sm text-gray-900"><?php echo $rows['first_name']; ?></div>
                                        </td>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900"><?php echo $rows['start_time']; ?></div>
                                        </td>


                                        <td class="px-3 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <a href="http://localhost/sportsclub/sportclubdashboard/DeletePlayer.php?id=<?php echo $rows['reg_id']; ?>" class="text-indigo-600 hover:text-indigo-900 text-center">DELETE</a>
                                        </td>
                                    </tr>
                        <?php
                                }

...
<form class="relative px-5 mt-4 bg-gray-100 bg-opacity-0">
    ...
    <input class="focus:border-light-blue-500 focus:ring-1 focus:ring-light-blue-500 focus:outline-none w-full text-sm text-white placeholder-white border border-gray-200 rounded-md py-2 pl-10 mb-6  bg-gray-500 bg-opacity-70" type="text" aria-label="Search" placeholder="SEARCH" name="search_bookings" id="search_bookings" />
</form>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-100 bg-opacity-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-center text-m-12 font-medium text-white uppercase tracking-wider">
                                Delete Booking
                            </th>
                        </tr>
                    </thead>
                        ...
                        ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap event_name">
                                            <div class="text-m-12 text-white"><?php echo $rows['first_name']; ?></div>
                                        </td>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-m-12 text-white"><?php echo $rows['sport']; ?></div>
                                        </td>

                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-m-12 text-white"><?php echo $rows['date']; ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-m-12 text-white"><?php echo $rows['start_time']; ?></div>
                                        </td>


                                        <td class="px-3 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <a href="http://localhost/sportsclub/sportclubdashboard/DeletePlayer.php?id=<?php echo $rows['reg_id']; ?>" class="text-white hover:text-gray-400 text-center">DELETE</a>
                                        </td>
                                    </tr>
                        <?php
                                }

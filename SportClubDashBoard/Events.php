                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td class="px-3 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <a href="http://localhost/sportsclub/sportclubdashboard/UpdateEvent2.php?id=<?php echo $rows['event_name']; ?>" class="text-white hover:text-gray-400 text-center">UPDATE</a>
                                        </td>

                                        <td class="px-3 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <a href="http://localhost/sportsclub/sportclubdashboard/DeleteEvent.php?id=<?php echo $rows['event_name']; ?>" class="text-white hover:text-gray-400 text-center">DELETE</a>
                                        </td>
                                    </tr>
                        <?php
                                }

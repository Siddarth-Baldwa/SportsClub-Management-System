                        ...
                        ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap event_name">
                                            <a href="http://localhost/sportsclub/sportclubdashboard/CoachInfo.php?id=<?php echo $rows['coach_id']; ?>" class="text-indigo-600 hover:text-indigo-900 font-semibold text-center"><?php echo $rows['coach_id']; ?></a>
                                        </td>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900"><?php echo $rows['first_name']; ?> <?php echo $rows['last_name']; ?></div>
                                        </td>

                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900"><?php echo $rows['associated_sport']; ?></div>
                                        </td>

                                        <td class="px-3 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <a href="http://localhost/sportsclub/sportclubdashboard/UpdateCoach.php?id=<?php echo $rows['coach_id']; ?>" class="text-indigo-600 hover:text-indigo-900 text-center">UPDATE</a>
                                        </td>

                                        <td class="px-3 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <a href="http://localhost/sportsclub/sportclubdashboard/DeleteCoach.php?id=<?php echo $rows['coach_id']; ?>" class="text-indigo-600 hover:text-indigo-900 text-center">DELETE</a>
                                        </td>
                                    </tr>
                        <?php
                                }
